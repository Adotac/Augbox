...
namespace Augbox
{
    ...
    {
        private Resolution _currentResolution = new Resolution { width = 1390, height = 720, refreshRate = 60 };
        private FullScreenMode _currentFullScreenMode = FullScreenMode.Windowed;
